...
BMUVOffsets BM_uv_map_get_offsets(const BMesh *bm)
{
  ...
  offsets.select_vert = CustomData_get_offset_named(
      &bm->ldata, CD_PROP_BOOL, BKE_get_uv_map_vert_selection_name(name, buffer));
  offsets.select_edge = CustomData_get_offset_named(
      &bm->ldata, CD_PROP_BOOL, BKE_get_uv_map_edge_selection_name(name, buffer));
  offsets.pin = CustomData_get_offset_named(
      &bm->ldata, CD_PROP_BOOL, BKE_get_uv_map_pin_name(name, buffer));
