...
static bool bvh_overlap_cb(void *userdata, int index_a, int index_b, int UNUSED(thread))
{
  ...
  const float *tri_a_co[3] = {data->vertices[data->loops[tri_a->tri[0]].v].co,
                              data->vertices[data->loops[tri_a->tri[1]].v].co,
                              data->vertices[data->loops[tri_a->tri[2]].v].co};
  const float *tri_b_co[3] = {data->vertices[data->loops[tri_b->tri[0]].v].co,
                              data->vertices[data->loops[tri_b->tri[1]].v].co,
                              data->vertices[data->loops[tri_b->tri[2]].v].co};
  float ix_pair[2][3];
  int verts_shared = 0;
