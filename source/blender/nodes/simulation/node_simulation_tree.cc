...
static void simulation_node_tree_get_from_context(const bContext *C,
...
static void simulation_node_tree_update(bNodeTree *ntree)
{
...
static bool simulation_node_tree_validate_link(eNodeSocketDatatype type_a,
...
static bool simulation_node_tree_socket_type_valid(bNodeTreeType *UNUSED(ntreetype),
...
void register_node_tree_type_simulation()
{
  ...
  strcpy(tt->ui_name, N_("Simulation Node Editor"));
  tt->ui_icon = ICON_PARTICLE_DATA;
  strcpy(tt->ui_description, N_("Simulation nodes"));
  tt->rna_ext.srna = &RNA_SimulationNodeTree;
  tt->update = simulation_node_tree_update;
  tt->get_from_context = simulation_node_tree_get_from_context;
  tt->foreach_nodeclass = foreach_nodeclass;
  tt->valid_socket_type = simulation_node_tree_socket_type_valid;
  tt->validate_link = simulation_node_tree_validate_link;
