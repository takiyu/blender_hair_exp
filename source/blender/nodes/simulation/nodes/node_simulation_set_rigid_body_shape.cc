...
namespace blender::nodes::node_simulation_set_rigid_body_shape_cc {
...
void register_node_type_simulation_set_rigid_body_shape()
{
  namespace file_ns = blender::nodes::node_simulation_set_rigid_body_shape_cc;

  static bNodeType ntype;

  simulation_node_type_base(
      &ntype, SIMULATION_NODE_SET_RIGID_BODY_SHAPE, "Set Shape", NODE_CLASS_GEOMETRY);
