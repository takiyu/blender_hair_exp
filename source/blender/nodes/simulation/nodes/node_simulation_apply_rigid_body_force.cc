...
void register_node_type_simulation_apply_rigid_body_force()
{
  namespace file_ns = blender::nodes::node_simulation_apply_rigid_body_force_cc;

  static bNodeType ntype;

  simulation_node_type_base(
      &ntype, SIMULATION_NODE_APPLY_RIGID_BODY_FORCE, "Apply Force", NODE_CLASS_GEOMETRY);
