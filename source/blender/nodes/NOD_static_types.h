...
DefNode(GeometryNode, GEO_NODE_SIMPLEX_TETRAHEDRALIZE, def_geo_simplex_tetrahedralize, "SIMPLEX_TETRAHEDRALIZE", SimplexTetrahedralize, "Tetrahedralize", "Construct a tetrahedral decomposition between points")
DefNode(GeometryNode, GEO_NODE_SIMPLEX_TO_MESH, def_geo_simplex_to_mesh, "SIMPLEX_TO_MESH", SimplexToMesh, "Simplex to Mesh", "Convert simplex decomposition into a mesh")
